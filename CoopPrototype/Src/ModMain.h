...
public:
    ...
    void ArmMultiplayerUiInputGuard();
...
private:
    ...
    bool m_multiplayerWaitForGamepadRelease = false;
    bool m_multiplayerUiGamepadConnected = false;
    bool m_multiplayerUiGamepadInputSuppressed = false;
    uint16_t m_multiplayerUiGamepadHeldButtons = 0;
    uint16_t m_multiplayerUiGamepadPressedButtons = 0;
    uint32_t m_multiplayerUiFocusedControlId = 0;
    uint32_t m_multiplayerUiActiveControlId = 0;
    uint32_t m_multiplayerUiLastActivatedControlId = 0;
    uint32_t m_multiplayerUiLastActivationFrame = 0;
    uint32_t m_multiplayerUiLastGamepadConfirmFrame = 0;
    uint64_t m_multiplayerUiActivationCount = 0;
    uint64_t m_multiplayerUiSessionGeneration = 0;
    std::string m_multiplayerUiFocusedControl = "-";
    std::string m_multiplayerUiActiveControl = "-";
    std::string m_multiplayerUiLastActivatedControl = "-";
    std::string m_multiplayerUiLastActivationSource = "-";
